...
export function Faq() {
	return (
		<section
			id="faq"
			className="scroll-mt-28 bg-bg-tertiary px-6 py-16 lg:px-20 lg:py-[120px]"
		>
			<div className="wrap flex flex-col items-center gap-10 lg:gap-12">
				...
				<CardShell
					as="dl"
					className="flex w-full max-w-[588px] flex-col bg-surface-tertiary px-2 py-2 sm:px-4"
				>
					{FAQS.map((faq) => (
						<div
							key={faq.question}
						...
						>
							<dt className="text-body-lg font-medium text-text-primary">
								{faq.question}
							</dt>
