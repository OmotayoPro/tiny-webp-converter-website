...
function BatchConvertCard() {
	return (
		<CardShell
			className="group flex h-[440px] w-full flex-col justify-end lg:w-[603px]"
			style={{
				background:
...
function FullControlCard() {
	return (
		<CardShell
			className="flex h-[440px] w-full flex-col justify-end lg:w-[421px]"
			style={{
...
function PrivateByDesignCard() {
	return (
		<CardShell
			className="flex h-[440px] w-full flex-col justify-end lg:w-[428px]"
			style={{
				background: "linear-gradient(180deg, #2b2b2b 0%, #1c1c1c 100%)",
			}}
		>
